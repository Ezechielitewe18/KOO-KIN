...
$page = [
    ...
    'actif' => 'livraison',
    'description' => 'Livraison de plats KOO-KIN Ã  Kinshasa dÃ¨s 11h. Consultez les frais par commune et commandez en ligne.',
    'fil' => 'Livraison',
];
    ...
    <div class="conteneur">
        <div class="grille grille--3" style="margin-bottom:2.6rem">
            ...
            <div class="carte-form animer">
                ...
                <h3>3. Livraison</h3>
                <p class="texte-doux">Votre repas part dÃ¨s 11h et arrive chaud, emballÃ© avec soin.</p>
            </div>
        </div>
        ...
        <div class="titre-section animer">
            ...
            <p class="texte-doux"><?= e((string) param('livraison_texte', 'Livraison Ã  Kinshasa. Ã€ partir de 6 000 CDF, selon le trajet et la commune.')) ?></p>
        </div>
        ...
        <?php if ($zones): ?>
            <div style="overflow-x:auto" class="animer">
                <table class="tableau">
                    <thead>
                        <tr><th>Commune</th><th>Zone</th><th style="text-align:right">Frais</th><th>DÃ©lai estimÃ©</th></tr>
                    </thead>
                    <tbody>
            ...
            <div class="menu-note animer" style="margin-top:1.4rem">
                Frais minimum : <?= e(format_prix($tarifMin)) ?>. Pour toute commune non listÃ©e, contactez-nous : le tarif sera confirmÃ© selon le trajet.
            </div>
        <?php else: ?>
            <div class="menu-note animer">Les zones de livraison seront bientÃ´t prÃ©cisÃ©es. Contactez-nous pour connaÃ®tre les frais applicables.</div>
        <?php endif; ?>

        <div class="carte-form animer" style="margin-top:2.6rem;text-align:center">
            <h2 style="font-size:1.5rem">Une envie de chez nous ?</h2>
            <p class="texte-doux">Choisissez vos plats et faites-vous livrer Ã  Kinshasa.</p>
